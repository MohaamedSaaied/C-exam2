...
namespace C_exam2
{
    internal class PracticalExam:Exam
    {
        ...
        public PracticalExam(DateTime TimeOfExam, int NumberOfQuestions, List<Question> questions) 
        {
        ...
        public override void ShowExam()
        {
            ...
            int totalMarks = 0;
            int fullmark = 0;
            Console.WriteLine("Practical Exam Questions:");
            foreach (var question in Questions)
            {
                Console.Clear();
                Console.WriteLine($" MCQ Question    Mark:{question.Mark} ");
